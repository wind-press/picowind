...
class Config
{
    private const OPTION_NAME = 'picowind_options';
    ...
    {
        $options = json_decode(get_option(self::OPTION_NAME, '{}'), null, 512, JSON_THROW_ON_ERROR);

        $options = apply_filters('f!picowind/utlis/config:options', $options);
    ...
    public static function set($path, $value)
    {
        ...
        update_option(self::OPTION_NAME, wp_json_encode($options, JSON_THROW_ON_ERROR));
    }
